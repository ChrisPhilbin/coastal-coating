<template>
  <div class="text-center pt-20 md:pt-2">
    ...
    <div class="relative md:hidden w-full">
      ...
      <button class="absolute bottom-5 left-1/2 transform -translate-x-1/2 -translate-y-5 h-16 w-52 rounded-lg bg-blue-400 text-white font-semibold text-lg z-10">Book appointment</button>
